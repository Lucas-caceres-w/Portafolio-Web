   ...
   const works = [
      {
         ...
         enlace: 'https://www.limpitodo.com.ar/',
         image: [{ img: '/assets/imagenes/limpitod.png' }],
         tecs: 'TiendaNube, CSS',
      },
      {
      ...
      },
      {
         ...
         image: [{ img: '/assets/imagenes/celebrolavida.png' }],
      ...
      },
      {
         ...
         enlace:
            'https://wifnix-desarrollo-git-main-lucas-caceres-w.vercel.app/',
