  ...
  const ModalWork = ({ titulo, descripcion, imagen, link, tecs }: Modal) => {
    return (
      <div className="fixed z-50 w-full h-screen top-0 backdrop-blur-sm transition-all delay-75 bg-neutral-900/60 grid place-items-center">
        <div data-aos="zoom-in w-11/12 md:w-10/12 xl:w-8/12 h-max md:h-[650px]">
          <section className="bg-neutral-800 w-11/12 md:w-10/12 xl:w-8/12 h-max md:h-[650px] m-auto relative rounded-md">
            <IconButton
              onClick={handleClose}
